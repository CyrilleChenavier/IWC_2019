...
\item In the case $\Theta = \{ \D \}$, with $\D = \partial - x$. For the
  ...
  $\partial\rewThetaS{P} x$. As a result we get:
  \[\partial \D = \partial^2 - \partial x = \partial^2 - x \partial - 1
  \rewThetaS{P} \partial^2 - x^2 - 1.
  \]
  ...
  $\partial^{n+1}\rewThetaS{L}\partial^n x$, where $L=J,T$. This yields:
  \[
  \partial\D=\partial^2-\partial x=\partial^2-x\partial-1\rewThetaS{L}
  \partial x-x^2-1=x\partial -x^2 \rewThetaS{L}0.
  \]
