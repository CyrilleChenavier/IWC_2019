...
We fix a set $\{x_1,\cdots,x_n\}$ of indeterminates and let $\QXX$ be the
field of fractions of the polynomial algebra $\QX$ over $\Q$.

\begin{definition}
  The {\it rational Weyl algebra} over $\QXX$ is the set of polynomials
  over the inderminates $\diff{i}$ and coefficients in $\QXX$, subject to
