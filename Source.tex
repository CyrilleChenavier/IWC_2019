...
\begin{remark}
  ...
  Ostroom for abstract rewriting systems. From this point of view, Theorem
  \ref{thm-S-conf} can be seen as an analogue of van Ostroom's result  \cite{van2008confluence}
