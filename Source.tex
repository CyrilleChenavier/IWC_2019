...
compatibilities with the underlying algebraic operations. In our view,
these two facts are a telltale sign that well-formed rewriting steps are
incompatible with the development of a general framework unifying
abstract and linear rewriting.
\begin{center}
