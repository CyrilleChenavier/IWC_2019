...
the form $x\rewR r$. The set $R$ induces a rewriting relation on $\KX$ which reduced many $x$'s at once and defined as follows:
\begin{small}
...
\begin{example}
  ...
  \begin{small}
    \[
    H(x) = z + t = H(y),\ H(y) = z + t = H(z + t),\ H(z) = z = H(y - t),
    \]
  \end{small}
